...
const AppNavigator = () => {
  return (
    <Stack.Navigator initialRouteName="Splash">
      ...
      <Stack.Screen name="BuyTokens" component={BuyTokensScreen} options={{ headerShown: false }} />
      <Stack.Screen name="PrivateChat" component={PrivateChatScreen} options={{ headerShown: false }} />
      <Stack.Screen name="Notifications" component={NotificationsScreen} options={{ headerShown: false }} />
      <Stack.Screen name="ModelProfile" component={ModelProfileScreen} options={{ headerShown: false }} />
