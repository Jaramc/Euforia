...
const ModelHomeScreen = ({ navigation }) => {
  ...
  const recentMessages = [
    ...
    },
    {
      id: "msg4",
      name: "Juan Pérez",
      message: "Hola, ¿cuánto cobras por una sesión privada?",
      time: "Ayer",
      unread: 0,
    },
    {
      id: "msg5",
      name: "Luis Ramírez",
      message: "Me encantaría conocerte mejor, ¿tienes tiempo?",
      time: "Lunes",
      unread: 3,
    },
    {
      ...
      message: "¿Qué servicios ofreces? Me interesa mucho",
      time: "Domingo",
      unread: 0,
    },
    {
      id: "msg7",
      name: "Diego Morales",
      message: "¿Podemos hablar en privado sobre tus tarifas?",
      time: "Sábado",
      unread: 1,
    },
  ]
        ...
        <View style={styles.content}>
          ...
          <View style={styles.sectionContainer}>
            ...
            {recentMessages.length > 0 ? (
              <FlatList
                data={recentMessages.slice(0, 3)} // Mostrar solo los 3 primeros mensajes
